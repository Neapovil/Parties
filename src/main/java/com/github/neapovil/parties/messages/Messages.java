...
public enum Messages
{
    ...
    PARTY_FRIENDLY_FIRE_ENABLED("party_friendly_fire_enabled"),
    PARTY_FRIENDLY_FIRE_DISABLED("party_friendly_fire_disabled"),
    PARTY_COLLISION_ENABLED("party_collision_enabled"),
    PARTY_COLLISION_DISABLED("party_collision_disabled");
